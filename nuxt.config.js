  ...
  head: {
    ...
    meta: [
      { charset: 'utf-8' },
      {
        name: 'viewport',
        content:
          'user-scalable=no, width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, height=device-height'
      },
      { name: 'author', content: '山姆极客工作室' },
      {
        hid: 'description',
        name: 'description',
        content: '山姆极客，热爱新科技，山姆博客，山姆极客创人严骏'
      },
      {
        name: 'description',
        content: 'samgeeker, vuejs hunter, full stacker, Black technology'
      },
